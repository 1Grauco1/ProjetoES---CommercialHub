...
def editar_contrato(db : Session, id_contrato : int, dados_contrato_atualizar : contrato_schemas.ContratoUpdate):
    ...
    dados = dados_contrato_atualizar.model_dump(
        exclude_unset= True
    )
